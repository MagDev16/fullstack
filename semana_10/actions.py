def add_students(students):
    ...
    for _ in range(n):
        ...
        for subjet in subjets: # Loop through each subject
            while True:
                try:
                    ...
                    if 0 <= note <= 100:
                        student[subjet] = note # Add grade to student record
                        break
                    else: 
        ...
        # Add the completed student record to the list
...
def show_students(students):
    ...
    for i, student in enumerate(students, 1):
        ...
        print(f"Promedio General: {overall_average:.2f}")  # Display average with 2 decimal places
...
def top3_students(students):
    ...
    for student in students:
        ...
        if key not in unique_students or overall_average > unique_students[key][1]:
            unique_students[key] = (student, overall_average)
